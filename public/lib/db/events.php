...
$observers = [
    ...
    [
        ...
        'callback'    => '\core_badges\event\observer::badge_criteria_review',
    ],
    [
        'eventname'   => '\core\event\course_completed',
        'callback'    => '\core_badges\event\observer::course_criteria_review',
    ],
    [
        'eventname'   => '\core\event\user_updated',
        'callback'    => '\core_badges\event\observer::profile_criteria_review',
    ],
    [
        'eventname'   => '\core\event\cohort_member_added',
        'callback'    => '\core_badges\event\observer::cohort_criteria_review',
    ],
    [
        'eventname'   => '\core\event\competency_evidence_created',
        'callback'    => '\core_badges\event\observer::competency_criteria_review',
    ],
    // Competencies.
    [
        'eventname'   => '\core\event\course_completed',
